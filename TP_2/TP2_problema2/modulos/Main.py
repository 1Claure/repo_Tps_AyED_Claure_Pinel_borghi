...
from Temperaturas_DB import TemperaturasDB

if __name__ == "__main__":

    def menu():
        
        temperaturas_db = TemperaturasDB()
        # Dataset de prueba
        datos_prueba = [
            ('01/01/2021', 25.0),
            ('02/01/2021', 26.0),
        ...
        for fecha, valor in datos_prueba:
            ...
            temperaturas_db.guardar_temperatura(valor, fecha)
            ...
            if opc == 1:
                ...
                while True:
                    try:
                        ...
                        continue
                print("La temperatura el {} fue de: {}°C".format(fecha_bus.strftime('%d/%m/%Y'), temperaturas_db.devolver_temperatura(fecha_bus)))
            elif opc == 3:
                while True:
                    try:
                        ...
                        print("Ingresaste una fecha invalida. Por favor, ingresa una fecha valida en formato dd/mm/aaaa.")
                        continue
                max_temp = temperaturas_db.max_temp_rango(fecha_1,fecha_2)
                ...
                while True:
                    try:
                        ...
                        print("Ingresaste una fecha invalida. Por favor, ingresa una fecha valida en formato dd/mm/aaaa.")
                        continue
                min_temp = temperaturas_db.min_temp_rango(fecha_1,fecha_2)
                ...
                while True:
                    try:
                        ...
                        print("Ingresaste una fecha invalida. Por favor, ingresa una fecha valida en formato dd/mm/aaaa.")
                        continue
                temperaturas_db.borrar_temperatura(fecha)
            elif opc == 7:
                while True:
                    try:
                        fecha_1 = datetime.strptime(input("Ingrese la primer fecha (en formato dd/mm/aaaa): "), '%d/%m/%Y').date()
                        ...
                        print("Ingresaste una fecha invalida. Por favor, ingresa una fecha valida en formato dd/mm/aaaa.")
                        continue
                temperaturas = temperaturas_db.devolver_temperaturas(fecha_1,fecha_2)
                for temperatura in temperaturas:
                    print(temperatura)
            elif opc == 8:                                        
                print("La cantidad de muestras es: ", temperaturas_db.cantidad_muestras())                   
            elif opc == 9:                                      
                print("Adios")
                break 
            else:
